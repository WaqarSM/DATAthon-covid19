...
"use strict";angular.module("onesite.contact.us.services",[]).factory("contactUsService",["remoteStorageService","sessionService","dataBindingService","apiEndpointConfig","componentApiService","redirectService","$q","$parse",function(a,e,t,l,p,v,f,g){var r={};return r.getContactNode=function(r,n,e){var t,i,o,a,c,s="/"+l["onesite.app"].apiService,d=l["onesite.app"].apiServiceCrossDomain,u=f.defer();return(t=e,i=n,o="/"+l["onesite.app"].apiService,a=l["onesite.app"].apiServiceCrossDomain,c=f.defer(),p.getEntity({url:v.respectProtocol(i.useRelativeUrl?o:a+o)+"/url/"+t,method:"GET",withCredentials:i.withCredentials}).then(function(e){var t=angular.isArray(e)?g("und[0].id")({und:e}):e.id;t?c.resolve(t):c.reject()},function(){c.reject()}),c.promise).then(function(t){if(angular.isString(t)&&""!==t.trim()){var e=encodeURIComponent(t);p.getEntity({url:v.respectProtocol(n.useRelativeUrl?s:d+s)+"/"+e+"?fields="+r,method:"GET",withCredentials:n.withCredentials}).then(function(e){u.resolve({alias:t,content:angular.isArray(e)?e[0]:e})},function(){u.reject()})}else u.reject()},function(){u.reject()}),u.promise},r.Handler=function(e){return t=e.alias,r=e.ministryId,n=e.contactId,i={isLocked:!1,remote:{handler:new a.Handler({endPoint:"contact"})}},o=!!n,{set:function(e){return function(e,t,r,n,i){var o=this,a=f.defer();return!e||o.isLocked?a.reject():(o.isLocked=!0,t.referrer=r,t.contactId=parseInt(i),t.userAgent=navigator.userAgent,t.grecaptchaResponse=grecaptcha.getResponse(),o.remote.handler({alias:r,contactId:parseInt(i),ministryId:parseInt(n),contactUs:t}).then(function(){a.resolve(),o.isLocked=!1},function(){a.reject(),o.isLocked=!1})),a.promise}.call(i,o,e,t,r,n)}};var t,r,n,i,o},r}]);
...
playback timings (ms):
  ...
  LoadShardBlock: 114.486 (4)
  captures_list: 1289.779
  RedisCDXSource: 3.265
  exclusion.robots.policy: 0.218
  PetaboxLoader3.resolve: 49.467
  esindex: 0.016
  PetaboxLoader3.datanode: 122.628 (6)
  load_resource: 97.473
  CDXLines.iter: 98.087 (4)
*/