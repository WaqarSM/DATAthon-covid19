...
var mh=function(){var a=kh("gac");if(a)return decodeURIComponent(a);var b=ih(),c=[];C(b,function(d,e){for(var f=[],h=0;h<e.length;h++)f.push(e[h].fg);f=Ig(f);f.length&&c.push(d+":"+f.join(","))});return c.join(";")},nh=function(a,b,c,d,e){hh(b,c,d,e);var f=dh[eh(b)],h=Ag().dc||[],k=!1;if(f&&0<h.length){var l=Wc.joined_au=Wc.joined_au||{},m=b||"_gcl";if(!l[m])for(var n=0;n<h.length;n++){var r="https://web.archive.org/web/20200312010653/https://adservice.google.com/ddm/regclk";r=r+"?gclid="+h[n]+"&auiddc="+f;tc(r);k=l[m]=!0}}null==a&&(a=k);if(a&&f){var t=
...
/*
     FILE ARCHIVED ON 01:06:53 Mar 12, 2020 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  load_resource: 63.123
  esindex: 0.014
  PetaboxLoader3.datanode: 46.713 (4)
  exclusion.robots.policy: 0.173
  CDXLines.iter: 11.988 (3)
  RedisCDXSource: 9.25
  exclusion.robots: 0.186
  LoadShardBlock: 38.884 (3)
  captures_list: 93.536
*/