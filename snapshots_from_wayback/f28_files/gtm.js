...
(y("require","ec","ec.js"),z());if(d.vtp_doubleClick||"DISPLAY_FEATURES"==d.vtp_advertisingFeaturesType){var pa="_dc_gtm_"+String(d.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");y("require","displayfeatures",void 0,{cookieName:pa})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==d.vtp_advertisingFeaturesType){var ma="_dc_gtm_"+String(d.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");y("require","adfeatures",{cookieName:ma})}M?y("send","pageview",M):y("send","pageview");}if(!a){var ua=d.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";d.vtp_useInternalVersion&&!d.vtp_useDebugVersion&&(ua="internal/"+ua);a=!0;var ab=R("https:","http:","//web.archive.org/web/20200227171113/https://www.google-analytics.com/"+ua,f&&f.forceSSL);
...
/*
     FILE ARCHIVED ON 17:11:13 Feb 27, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 21:48:44 Mar 20, 2020.
...
playback timings (ms):
  ...
  PetaboxLoader3.resolve: 52.43
  esindex: 0.023
  captures_list: 598.095
  PetaboxLoader3.datanode: 552.353 (4)
  RedisCDXSource: 1.107
  load_resource: 86.335
  exclusion.robots.policy: 0.292
  exclusion.robots: 0.315
  LoadShardBlock: 550.343 (3)
*/